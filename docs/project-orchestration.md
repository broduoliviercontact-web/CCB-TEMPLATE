...
D2 uses loopback Ollama only. It performs no provider fallback, network access to remote hosts, shell interpretation of stored data, modification of project sources, or Git command. VERSION is 1.7.1 and V1.7.0 runs need no migration.
